...
// then the algorithm performs nearly   10^9 × 10^4 = 10^13
...
// Binary Search performs  = log(maxPile)
// iterations. -->>>  Each iteration scans all piles.
...
// Binary Search performs approximately   = log₂(maxPile)
// iterations.  -> Each iteration scans all piles.
// Overall:   O(n × log(maxPile))
